...
`colon_recurrence` is bundled with TernTables. It contains 929 patients from a
...
`?colon_recurrence` for full details.
...
`export_to_word()` formats any TernTables tibble as a publication-ready
