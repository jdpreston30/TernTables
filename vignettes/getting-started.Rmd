...
and takes them all the way from raw data to a formatted Word document table ready
to paste into a manuscript, without any manual formatting steps.
...
![Descriptive table exported to Word with category section headers.](figures/tern_descriptive.png){width=100%}
